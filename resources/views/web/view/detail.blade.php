...
@section('header')
    <style>
        ...
        /* Gaya untuk teks "Pakaian Lain" */
        .container-fluid.text-center h3 {
            color: #ffffff; /* Ganti dengan warna putih (#ffffff) atau warna yang diinginkan */
        }
    </style>
@endsection
...
@section('main')
    ...
    @endphp
    <div class="container-fluid p-3" style="background: #007bff">
        @if (session('success'))
