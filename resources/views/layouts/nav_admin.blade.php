<nav class="navbar shadow-xl" style="background-color: #007bff;">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" style="color: white;"
            ...
            <div class="offcanvas-header" style="background-color: #007bff; color: white;">
        ...
        <img width="150px" src="{{ asset('img/Thrift.png') }}">
    </div>
</nav>
